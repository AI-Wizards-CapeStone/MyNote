...
| `npm run dev` | Starts local dev server at `localhost:3003` and backend server |
| `fastapi run server/test.py --port 9000 --reload` | Starts local dev server at `localhost:3003` and backend server |
